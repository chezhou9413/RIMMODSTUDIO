...
public class WorldDrawLayer_Landmarks : WorldDrawLayer
{
	...
	public override IEnumerable Regenerate()
	{
		...
		{
			PlanetTile planetTile = default(PlanetTile);
			Landmark landmark = default(Landmark);
			foreach (KeyValuePair<PlanetTile, Landmark> landmark3 in Find.World.landmarks.landmarks)
			{
				landmark3.Deconstruct(ref planetTile, ref landmark);
				PlanetTile tile = planetTile;
