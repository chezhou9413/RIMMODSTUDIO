...
public class Pawn_InfectionVectorTracker : IExposable
{
	...
	{
		InfectionPathwayDef infectionPathwayDef = default(InfectionPathwayDef);
		InfectionPathway infectionPathway = default(InfectionPathway);
		foreach (KeyValuePair<InfectionPathwayDef, InfectionPathway> pathway in pathways)
		{
			pathway.Deconstruct(ref infectionPathwayDef, ref infectionPathway);
			infectionPathway.TickInterval(delta);
		}
	...
	private void RemoveExpiredPathways()
	{
		...
		{
			pathway.Deconstruct(ref infectionPathwayDef, ref infectionPathway);
			InfectionPathway infectionPathway2 = infectionPathway;
	...
	private void ReducePathwaysForNewPathway()
	{
		...
		{
			pathway.Deconstruct(ref infectionPathwayDef, ref infectionPathway);
			InfectionPathway item = infectionPathway;
