...
public class BackCompatibilityConverter_Universal : BackCompatibilityConverter
{
	...
	public override string BackCompatibleDefName(Type defType, string defName, bool forDefInjections = false, XmlNode node = null)
	{
		if (defType == typeof(ThingDef))
		{
			...
			case "Apparel_OxygenRebreather":
				return "Apparel_VacsuitHelmet";
			case "UnfinishedVacsuit":
				return "UnfinishedTechArmor";
			case "UnfinishedRebreather":
				return "UnfinishedTechArmor";
			case "FlightSubpersonaCore":
				return "PilotSubpersonaCore";
			case "AncientBarbedWireFence":
				return "AncientRazorWire";
			case "AncientMilitaryCrateSmall":
				return "AncientMilitaryCrate";
			case "AncientTunellerClaw":
				return "AncientTunnelerClaw";
			case "AncientTunellerHusk":
				return "AncientTunnelerHusk";
			case "GravBeacon":
				return "GravAnchor";
			case "BlocksStellite":
				return "BlocksVacstone";
			case "Tile_MorbidStellite":
				return "Tile_MorbidVacstone";
			case "Tile_SpikecoreStellite":
				return "Tile_SpikecoreVacstone";
			case "Tile_TotemicStellite":
				return "Tile_TotemicVacstone";
			case "Stellite_Rough":
				return "Vacstone_Rough";
			case "TileStellite":
				return "TileVacstone";
			case "FlagstoneStellite":
				return "FlagstoneVacstone";
			case "Stellite":
				return "Vacstone";
			case "ChunkStellite":
				return "ChunkVacstone";
			case "SmoothedStellite":
				return "SmoothedVacstone";
			case "FineTileStellite":
				return "FineTileVacstone";
			}
		}
		...
		if (defType == typeof(QuestScriptDef) && defName == "OpportunitySite_AnicentComplex_Giver")
		{
			return "OpportunitySite_AncientComplex_Giver";
		}
		return null;
	}
