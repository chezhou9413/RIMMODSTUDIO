...
public class Graphic_Linked : Graphic
{
	...
	public virtual bool ShouldLinkWith(IntVec3 c, Thing parent)
	{
		...
		if (ModsConfig.OdysseyActive && (parent.Map.terrainGrid.FoundationAt(c)?.IsSubstructure ?? false) != (parent.Map.terrainGrid.FoundationAt(parent.Position) == TerrainDefOf.Substructure))
		{
			return false;
		}
