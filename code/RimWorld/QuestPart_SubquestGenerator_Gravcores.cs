...
public class QuestPart_SubquestGenerator_Gravcores : QuestPart_SubquestGenerator
{
	...
	{
		if (subquestDefs.Count != 0 && CanGenerateSubquest && (Rand.MTBEventOccurs(MTB, 1f, 1f) || (float)Find.TickManager.TicksGame > lastSubquestTick + (float)MaxTime))
		{
			TryGenerateSubquest();
		}
	}
	...
	public override void ExposeData()
	{
		...
		if (Scribe.mode == LoadSaveMode.PostLoadInit)
		{
			...
			givenFirstSubquest = quest.GetSubquests().Any();
		}
	}
}
