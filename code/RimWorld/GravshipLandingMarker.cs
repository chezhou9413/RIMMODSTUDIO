...
public class GravshipLandingMarker : Thing
{
	...
	protected override void DrawAt(Vector3 drawLoc, bool flip = false)
	{
		...
		Thing thing = default(Thing);
		PositionData.Data data = default(PositionData.Data);
		foreach (KeyValuePair<Thing, PositionData.Data> exteriorDoorPlacement in gravship.ExteriorDoorPlacements)
		{
			exteriorDoorPlacement.Deconstruct(ref thing, ref data);
			Thing thing2 = thing;
			PositionData.Data data2 = data;
