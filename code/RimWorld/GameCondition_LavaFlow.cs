...
public class GameCondition_LavaFlow : GameCondition
{
	...
	public Rot4? trailerForceStartEdge;
	...
	{
		Rot4 edge = trailerForceStartEdge ?? Rot4.Random;
	...
	{
		int interval = 5;
		if (DebugSettings.evenFasterLavaFlow)
		{
			interval = 1;
		}
		else if (DebugSettings.fastLavaFlow)
		{
			interval = 2;
		}
		if (base.SingleMap.IsHashIntervalTick(interval))
		{
			SpreadLava();
